...
export const Hero = () => {
  ...
  return (
    <header id="top" className="relative overflow-hidden bg-gradient-to-br from-[#0B132B] via-[#1C2541] to-[#3E92CC]">
      ...
      <div className="relative z-10 container pt-4 pb-[28rem] lg:pb-[15rem] xl:pb-[16rem] xl2:pb-[17rem] 2xl:pb-[18rem] 2xl3:pb-[21rem] 2xl2:pb-[21rem] 3xl:pb-[30rem] 4xl:pb-[33rem] flex flex-col lg:block min-h-[calc(100vh-80px)] lg:min-h-0 lg:h-auto justify-center lg:justify-start">
